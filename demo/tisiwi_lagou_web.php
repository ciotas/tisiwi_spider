...
$configs = array(
    ...
    'list_url_regexes' => array(  //定义列表页url的规则
        "https://www.lagou.com/gongsi\?pn=\d+",
    ),
    'content_url_regexes' => array( //定义内容页url的规则
        "https://www.lagou.com/gongsi/\d+.html",
    ),
    ...
    'fields' => array(  //定义内容页的抽取规则
        ...
        array(
            'name' => "item_id",
            'selector' => "//input[@id='companyId']/@value",
            'required' => true,
        ),
        // 项目名
        array(
            'name' => "item_name",
            'selector' => "//a[contains(@class,'hovertips')]/text()",
            'required' => true,
        ),
        // 项目item_logo
        array(
            'name' => "item_logo",
            'selector' => "//div[contains(@class,'top_info_wrap')]/img/@src",
            'required' => true,
        ),
        // 项目item_brief
        array(
